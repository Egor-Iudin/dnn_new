...
data_transformation data_trans_parse(char *s0)
{
...
char *data_trans_build(data_transformation t /* Data transformation */
)
{
  static char s[100];
  char u[50];
...
double data_trans(double d,             /* Data value */
...
double data_inv_trans(double d,             /* Data value */
                      data_transformation t /* Transformation to apply */
)
{
  if (isnan(d))
