     ...
     char **argv)
{
  ...
  if (argc == 2)
  {
    ...
    {
      if (ds->trans[i].take_log || ds->trans[i].data_shift || ds->trans[i].data_scale || ds->trans[i].shift != 0 || ds->trans[i].scale != 1)
      {
        anytrans = 1;
        break;
      }
    ...
    {
      if (ds->trans[N_inputs + i].take_log || ds->trans[N_inputs + i].data_shift || ds->trans[N_inputs + i].data_scale || ds->trans[N_inputs + i].shift != 0 || ds->trans[N_inputs + i].scale != 1)
      {
        anytrans = 1;
        break;
      }
  ...
  if (*ap == 0 || (N_inputs = atoi(*ap++)) < 0 || N_inputs == 0 && strcmp(*(ap - 1), "0") != 0)
    usage();
  if (*ap == 0 || (N_targets = atoi(*ap++)) < 0 || N_targets == 0 && strcmp(*(ap - 1), "0") != 0)
    usage();
  ...
  if (*ap != 0 && strcmp(*ap, "/") == 0)
  {
    ...
    if (*ap != 0 && strcmp(*ap, "/") == 0)
    {
           ...
           i++)
      {
        ...
        if (ds->int_target && (ds->trans[ds->N_inputs + i].data_shift || ds->trans[ds->N_inputs + i].data_scale))
        {
          fprintf(stderr,
