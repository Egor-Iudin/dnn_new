...
void parse_range(char *str,   /* String to parse */
...
void parse_time_range(char *str,    /* String to parse */
...
void parse_flags(char *s, /* String to parse */
...
int list_flags(char *a,  /* Char array holding flag bits */
               int n,    /* Length of a */
...
int not_omitted(char *a, /* Char array holding omit flag bits, null if none */
