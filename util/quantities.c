...
int quantities_requested(quantities_described qd, /* Place to store which quantities are wanted */
...
void quantities_available(quantities_described qd, /* Descriptions of quantities wanted */
...
quantities_held *quantities_storage(quantities_described qd /* Description of quantities being evaluated */
)
{
  quantities_held *qh;
  int s, t, i;
...
void quantities_evaluate(quantities_described qd, /* Descriptions of quantities desired */
