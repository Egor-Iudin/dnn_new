...
void identity_matrix(double *m, /* The matrix to set to the identity */
...
double squared_norm(double *v, /* The vector */
...
double inner_product(double *v1, /* First vector */
...
void matrix_product(double *m1, /* Left operand */
...
double trace_of_product(double *m1, /* Left operand */
                        double *m2, /* Right operand */
...
int cholesky(double *m, /* The matrix */
...
int inverse_from_cholesky(double *m, /* Cholesky decomposition, replaced by inverse */
...
void fill_lower_triangle(double *m, /* Matrix to fill lower triangle from upper triangle */
                         int n      /* Number of rows and columns in matrix */
)
{
  double *p, *q;
...
void fill_upper_triangle(double *m, /* Matrix to fill upper triangle from lower triangle */
                         int n      /* Number of rows and columns in matrix */
)
{
  double *p, *q;
...
void forward_solve(double *m, /* The matrix L, only the lower-triangle is looked at */
...
void backward_solve(double *m, /* The matrix L, only the lower-triangle is looked at */
                    double *x, /* Place to store solution */
                    int xo,    /* Offset from one element to the next in x */
                    double *b, /* The vector b */
                    int bo,    /* Offset from one element to the next in b */
...
int jacobi(double *m,  /* The matrix, in upper triangle */
