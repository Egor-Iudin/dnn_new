...
int prior_parse(prior_spec *pr, /* Place to store prior */
...
char *prior_show(char *s,      /* Place to store string */
                 prior_spec pr /* Prior */
)
{
  char s1[100], s2[100];
...
double prior_width_scaled(prior_spec *pr, /* Prior to find scaling for */
...
double prior_pick_sigma(double sigma, /* Square root of inverse of mean precision */
...
double cond_sigma(double width,  /* Width parameter for top-level prior */
