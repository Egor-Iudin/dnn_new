...
void mc_slice_1(mc_dynamic_state *ds, /* State to update */
...
void mc_slice(mc_dynamic_state *ds, /* State to update */
              mc_iter *it,          /* Description of this iteration */
...
void mc_slice_gaussian(mc_dynamic_state *ds, /* State to update */
                       mc_iter *it,          /* Description of this iteration */
                       mc_value *save,       /* Place to save current state */
...
void mc_slice_over(mc_dynamic_state *ds, /* State to update */
                   mc_iter *it,          /* Description of this iteration */
...
)
{
  ...
  for (k = firsti; k <= lasti; k++)
  {
    ...
    if (ds->q[k] < olow_bnd || ds->q[k] > ohigh_bnd || ds->pot_energy > slice_point || (max_steps < 0 && !dbl_ok(ds, it, k, slice_point, curr_q, dlow_bnd, dhigh_bnd)))
    {
      ds->q[k] = curr_q;
      it->rejects += 1;
      ds->know_pot = 0;
...
static void step_out(mc_dynamic_state *ds, /* Current state */
                     mc_iter *it,          /* Description of this iteration */
...
static void dbl_out(mc_dynamic_state *ds, /* Current state */
                    mc_iter *it,          /* Description of this iteration */
                    int k,                /* Index of coordinate being updated */
                    double slice_point,   /* Potential energy level that defines slice */
                    double curr_q,        /* Current value for coordinate */
...
static int dbl_ok(mc_dynamic_state *ds, /* Current state */
                  mc_iter *it,          /* Description of this iteration */
                  int k,                /* Index of coordinate being updated */
                  double slice_point,   /* Potential energy level that defines slice */
                  double curr_q,        /* Current value for coordinate */
...
static void pick_value(mc_dynamic_state *ds, /* Current state, updated with new value */
                       mc_iter *it,          /* Description of this iteration */
                       int k,                /* Index of coordinate being updated */
                       double slice_point,   /* Potential energy level that defines slice */
                       double curr_q,        /* Current value for coordinate */
...
)
{
  ...
  for (;;)
  {
    ...
    if (ds->pot_energy <= slice_point && (max_steps >= 0 || dbl_ok(ds, it, k, slice_point, curr_q, low_bnd, high_bnd)))
    {
      return;
    }
...
void mc_slice_inside(mc_dynamic_state *ds, /* State to update */
                     mc_iter *it,          /* Description of this iteration */
...
void mc_slice_outside(mc_dynamic_state *ds, /* State to update */
                      mc_iter *it,          /* Description of this iteration */
                      int steps,            /* Number of steps to take */
