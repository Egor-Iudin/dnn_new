...
void mc_heatbath(mc_dynamic_state *ds, /* State to update */
...
void mc_radial_heatbath(mc_dynamic_state *ds, /* State to update */
                        float temperature     /* Temperature of heat bath */
)
{
...
void mc_mix_momentum(mc_dynamic_state *ds, /* State to update */
