...
void net_print_params(net_params *w,         /* Network parameters */
...
void net_print_sigmas(net_sigmas *s,         /* Network sigmas, null if none to display */
                      net_arch *a,           /* Network architecture */
                      net_flags *flgs,       /* Network flags, null if none */
                      model_specification *m /* Data model, may be null */
)
...
static void print_param_array(net_param *p,
                              int n,
                              int op)
{
  int i;
...
static void print_sigma_array(net_sigma *s,
                              int n)
{
  int i;
