...
void net_back(net_values *v,   /* Values for units in network */
...
)
{
  ...
  // printf("Net Back Start");
  for (l = a->N_layers - 1; l >= 0 && l >= start; l--)
  {
    // printf("Net Back Start2");
  ...
  // printf("Net Back Start 1");
  /* Backpropagate to input layer. */

  if (start < 0)
  {
    //  printf("Net Back Start4");
...
static void zero_derivatives(net_value *d, /* Derivatives with respect to units to zero */
...
static void sum_derivatives(net_value *dd, /* Derivatives with respect to destination units */
