...
Logger::Logger(unsigned stdVerbLevel_) : stdVerbLevel(stdVerbLevel_),
                                         fileVerbLevel(0),
                                         file(nullptr),
...
Logger::Logger(unsigned stdVerbLevel_, unsigned fileVerbLevel_, std::string const &fileName) : stdVerbLevel(stdVerbLevel_),
